        ...
        >
            <el-form-item label="类型">
                <el-radio-group v-model="type" @change="changeType">
                    <el-radio-button :disabled="typeItemDisabled(type)" :label="0">
                        目录
                    </el-radio-button>
                    <el-radio-button :disabled="typeItemDisabled(type)" :label="1">
                        菜单
                    </el-radio-button>
                    <el-radio-button :disabled="typeItemDisabled(type)" :label="2">
                        按钮
                    </el-radio-button>
                </el-radio-group>
            </el-form-item>
